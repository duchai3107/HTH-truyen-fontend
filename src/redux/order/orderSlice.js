...
export const orderSlice = createSlice({
    ...
    reducers: {
        doAddBookAction: (state, action) => {
            ...
            //update redux
            state.carts = carts;
            message.success("Truyện đã được thêm vào thư viện")
        },
...
export const { doAddBookAction, doUpdateCartAction, doDeleteItemCartAction, doPlaceOrderAction, doDeleteBookAction } = orderSlice.actions;
